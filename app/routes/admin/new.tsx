...
export default function NewPost() {
    ...
    return (
        <Form method={'post'}>
            <p>
                <label>
                    Post Title: { errors?.title ? <em>Title is required</em> : null} <input type={'text'} name={'title'}/>
                </label>
            </p>
            <p>
                <label>
                    Post Slug: { errors?.slug ? <em>Slug is required</em> : null} <input type={'text'} name={'slug'}/>
                </label>
            </p>
            <p>
